...
import vn.com.t3h.service.request.RequestData;
...
public class ClaimResource {
    ...
    @GetMapping()
    public ResponseEntity<BaseResponse<List<ClaimDTO>>> getListClaim(
    ...
    @PostMapping()
    public ResponseEntity<BaseResponse<List<ClaimDTO>>> getPostClaimsTarget(
        ...
        BaseResponse<List<ClaimDTO>> response = claimService.getClaims(claimCode,fromDate,toDate,statusName,pageable);
