...
<head>
    ...
    <title>Admin: Xóa người dùng</title>
...
<section class="section-content">
    <div class="container">
        <header class="section-heading py-4 d-flex justify-content-between">
            <h3 class="section-title">Xóa người dùng</h3>
        </header> <!-- section-heading.// -->
        <main class="add-book-form mb-5">
            <form:form action="/api/users/delete" class="w-50" method="post" modelAttribute="newUser">
