...
public class ProductEmployeeDaoImpl implements ProductEmployeeDao {
    ...
    public List<ProductModel> listProductEmployee() {
        ...
        String sql = "select * from product_employee";
    ...
    public int addProductEmployee(ProductModel product) {
        System.out.println("--------------- ADD PRODUCT EMPLOYEE ---------------");
        ...
        try {
            ...
            // Thêm mới nhân viên
            String sql = "INSERT INTO product_employee (name, price, discount, quantity, totalBuy, author, pages, publisher, yearPublishing, description, imageName, shop," +
            ...
            System.out.println("--------------- ADD PRODUCT EMPLOYEE SUCESSFULL ---------------");
            connection.commit();
    ...
    public int updateProductEmployee(ProductModel product) {
        ...
        try {
            ...
            String sql = "UPDATE product_employee SET name = ?, price = ?, discount = ?, quantity = ?, totalBuy = ?, author = ?, pages = ?, publisher = ?, yearPublishing = ?, description = ?, imageName = ?, shop = ?, createdAt = ?, updatedAt = ?, startsAt = ?, endsAt = ?, created_by = ? WHERE id = ?";
            statement = connection.prepareStatement(sql);
            statement.setString(1, product.getName());
            statement.setDouble(2, product.getPrice());
            statement.setDouble(3, product.getDiscount());
    ...
    public int deleteProductEmployee(int id) {
        ...
        try {
            ...
            String sql1 = "DELETE FROM product_employee WHERE id = ?";
    ...
    public ProductModel findProductEmployeeById(int idFind) {
        ...
        String sql = "SELECT * FROM product_employee WHERE id = ?";
