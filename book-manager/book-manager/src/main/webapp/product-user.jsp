    ...
    <div class="container">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="#">Sách giáo khoa</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tiếng Việt lớp 1</li>
            </ol>
        </nav>
    </div> <!-- container.// -->
        ...
        <div class="row">
                ...
                <div id="productImageCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://www.sachbaokhang.vn/uploads/files/2023/05/01/van-5.jpg" class="d-block w-100" alt="...">
                        </div>
            ...
            <main class="col-md-7 col-lg-6">
                ...
                <%
                    ...
                    ProductModel productModel = productService.findProductById(Integer.parseInt(id));
                    request.setAttribute("productModel", productModel);
                    request.setAttribute("id2", id2);
                    request.getSession().setAttribute("currentProduct", productModel);

                %>

                <h2 class="title">${productModel.name}</h2>
            ...
            <span class="rating-stars me-2">
              ...
              <i class="bi bi-star-fill"></i>
                    ...
                    <small class="label-rating text-muted me-2">20 đánh giá</small>
                    <small class="label-rating text-success"><i class="bi bi-bag-check-fill"></i> 150 đã mua</small>
                </div>

                <div class="mb-4">
                    <span class="price h4">${productModel.price}</span>
                    <span class="ms-2 text-muted text-decoration-line-through">50.000₫</span>
                </div>

                <dl class="row mb-4">
                    <dt class="col-xl-4 col-sm-5 col-6">Nhà xuất bản</dt>
                    <dd class="col-xl-8 col-sm-7 col-6"><a href="#">${productModel.publisher}</a></dd>
                ...
                <div>
                    <form action="/add-order-temp?id=${productModel.id}&id2=${id2}" method="POST">
                        <h3>Số lượng:</h3>
                        <br>
                        <input type="number" name="quantity" class="form-control w-50" value="1" min="1" max="1000" step="1" />
                        <br>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <p>
                    Vestibulum at lectus eu mi volutpat condimentum sed vel libero. Etiam a finibus odio, sit amet
                    pellentesque lorem. Proin sodales auctor ex, in tempus nunc dapibus ac. Sed sit amet tellus dui.
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pellentesque at justo sed
                    rutrum. Proin ac justo et libero iaculis malesuada. Quisque posuere urna eget nulla malesuada,
                    sit amet mattis elit eleifend. Integer et mollis elit. Integer et massa at ipsum hendrerit porta
                    quis vehicula nibh. Nullam tellus urna, blandit sed ligula a, posuere scelerisque massa. In ac
                    lectus non risus facilisis finibus. Nulla neque risus, sodales et mi nec, lobortis scelerisque
                    arcu. Proin at lectus ex.
                </p>
                <p>
                    Nulla vel ante euismod, bibendum urna a, dapibus velit. Praesent vel magna mi. Vestibulum ante
                    ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Phasellus bibendum
                    tincidunt nibh. Fusce faucibus viverra ipsum, quis sagittis sem fermentum vel. Maecenas aliquet
                    vulputate finibus. Cras vestibulum vel lacus sit amet convallis. Aliquam finibus egestas dui, id
                    iaculis lectus lacinia nec. Praesent bibendum lorem at sem facilisis, quis placerat lorem
                    laoreet.
                </p>
            </div>
        </div>
                ...
                <div class="ratting-form-wrapper">
                    <div class="ratting-form">
                        <form action="">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <textarea class="form-control" placeholder="Nội dung đánh giá" rows="3"></textarea>
                                </div>
                            </div>
