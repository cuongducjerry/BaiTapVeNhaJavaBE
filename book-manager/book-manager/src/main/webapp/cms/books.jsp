...
<section class="section-content">
    <div class="container">
        <header class="section-heading py-4 d-flex justify-content-between">
            ...
            <a class="btn btn-primary" href="/cms/add-book.jsp" role="button" style="height: fit-content;">Thêm sản phẩm</a>
            ...
            <table class="table table-bordered table-striped table-hover align-middle">
                ...
                <c:forEach var="productModel" items="${listProducts}">
                    <tr>
                        ...
                        <td>${productModel.author}</td>
                        <td>${productModel.pages}</td>
                        <td>${productModel.publisher}</td>
                        <td>${productModel.yearPublishing}</td>
                        <td style="display:flex; justify-content: space-evenly;">
                            <a href="/cms/update-book.jsp?id=${productModel.id}" class="btn btn-warning btn-sm">
                                Sửa
                            </a>
                            <form action="/delete-book?id=${productModel.id}" method="post">
