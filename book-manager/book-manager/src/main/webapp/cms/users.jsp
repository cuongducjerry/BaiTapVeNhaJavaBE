...
<section class="section-content">
  <div class="container">
    <header class="section-heading py-4 d-flex justify-content-between">
      ...
      <a class="btn btn-primary" href="/cms/add-user.jsp" role="button" style="height: fit-content;">Thêm người dùng</a>
    ...
    <main class="table-responsive-xl mb-5">
      <table class="table table-bordered table-striped table-hover align-middle">
        ...
        <tbody>
        <c:forEach var="userModel" items="${listUsers}">
          <tr>
            <td>${userModel.id}</td>
            ...
            <td style="display:flex; justify-content: space-evenly;">
              <a href="/cms/update-user.jsp?id=${userModel.id}" class="btn btn-warning btn-sm">
                Sửa
              </a>
              <form action="/delete-user?id=${userModel.id}" method="post">
